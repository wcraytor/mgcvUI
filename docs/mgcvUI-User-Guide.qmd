...
**2. Import from earthUI (optional)** --- Import an earthUI result \texttt{.rds} file to seed the GAM with earth-discovered knot positions. This step is optional --- skip it if you do not have an earthUI result to import.
...
Section 2 of the sidebar --- **Import from earthUI** --- lets you import an earthUI result \texttt{.rds} file. This enables the earth--mgcv pipeline: earth's data-driven knot positions become anchor points for GAM smooth terms.
